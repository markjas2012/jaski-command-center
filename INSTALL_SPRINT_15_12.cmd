...
set "PACK=%~dp0"
set "BACKUP=%PROJECT%\_sprint_backups\15.12_Streaming_Responsive_Accessibility"

echo.
echo =================================================
echo  JASKI COMMAND CENTER - SPRINT 15.12
echo  Streaming Responsive + Accessibility Pass
echo =================================================
echo.
...
echo.
echo Sprint 15.12 installed.
echo Open http://localhost:3000/streaming
echo Hard refresh with Ctrl+Shift+R.
echo Desktop should remain visually consistent with 15.11.
echo Narrow the browser once to verify responsive behavior.
echo.
pause
