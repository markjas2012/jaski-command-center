...
set "PACK=%~dp0"
set "BACKUP=%PROJECT%\_sprint_backups\15.14_Streaming_Final_Detail_Pass"

echo.
echo =================================================
echo  JASKI COMMAND CENTER - SPRINT 15.14
echo  Streaming Final Detail Pass
echo =================================================
echo.
...
echo.
echo Sprint 15.14 installed.
echo Open http://localhost:3000/streaming
echo Hard refresh with Ctrl+Shift+R.
echo Confirm the page remains visually locked and keyboard focus is clean.
echo.
pause
