...
set "PACK=%~dp0"
set "BACKUP=%PROJECT%\_sprint_backups\15.11_My_Services_Polish"

echo.
echo =================================================
echo  JASKI COMMAND CENTER - SPRINT 15.11
echo  My Services Polish
echo =================================================
echo.
...
echo.
echo Sprint 15.11 installed.
echo Open http://localhost:3000/streaming
echo Hard refresh with Ctrl+Shift+R.
echo Verify My Services polish only.
echo Locked sections should remain unchanged.
echo.
pause
