...
set "PACK=%~dp0"
set "BACKUP=%PROJECT%\_sprint_backups\15.13_Streaming_Production_Finish"

echo.
echo =================================================
echo  JASKI COMMAND CENTER - SPRINT 15.13
echo  Streaming Production Finish
echo =================================================
echo.
...
echo.
echo Sprint 15.13 installed.
echo Open http://localhost:3000/streaming
echo Hard refresh with Ctrl+Shift+R.
echo Confirm the internal sprint label is gone and hover polish is subtle.
echo.
pause
